...
keys = [my_api_key4, my_api_key5, my_api_key6,
...
my_cse_id = "008462511346546009877:mroshlgt5tc"
...
palabras = ['Hurto bogotá','Seguridad ciudadana bogotá',
    ...
    for year in range(inicio, fin+1):
        ...
        try:
            ...
            for url in urls:                
                ...
                try:    
                    titulo = linksoup.find_all('h1', attrs = {'itemprop':'headline'})
                    for tit in titulo:
                        title = tit.text
                except:
                    title = '**Especial**'
...
test_df_tot.to_excel("Caracol_radio_articulos_total_2.xlsx")
errores.to_excel("Caracol_radio_errores_total_2.xlsx")
vacios.to_excel("Caracol_radio_vacios_total_2.xlsx")
