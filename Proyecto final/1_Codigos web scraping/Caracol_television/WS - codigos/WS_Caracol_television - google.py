...
print("\nWeb scraping - Caracol television\n")
...
my_cse_id = "008462511346546009877:kfsrs7snpaf"
...
Ya recopiladas:
 # Pasada 1    
'Seguridad bogotá', 'Homicidio bogotá', 'Policía Nacional bogotá','Fleteo bogotá',
'Dar de baja bogotá','Atraco bogotá',

 # Pasada 2:
'Hurto bogotá','Seguridad ciudadana bogotá',
            'Orden público bogotá',
"""

palabras = ['Violencia bogotá','Asesinato bogotá','Matar bogotá',
            'Robo bogotá','Orden público bogotá',
    ...
    for year in range(inicio, fin+1):
        ...
        try:
            ...
            for url in urls:                
                ...
                try:
                    fecha = linksoup.find('span', attrs = {'class': 'date'})
                    fecha = fecha.text
                ...
                try:                         
                    articulo_total = linksoup.find('div', attrs = {'class':'field field-name-body'})
            ...
            a_buscar2 = 'site:noticias.caracoltv.com ' + a_buscar
            link_err.append(a_buscar2)
            print('\nError en el loop; Pal: ', pal, '; Year: ', year)
...
test_df_tot.to_excel("Caracol_tv_articulos_total_2.xlsx")
errores.to_excel("Caracol_tv_errores_total_2.xlsx")
vacios.to_excel("Caracol_tv_vacios_total_2.xlsx")
...
password = 'Cerac_2019'
message = """Subject: Finalizo WS de Caracol television
