...
my_cse_id = "008462511346546009877:zd9sp5ybwtt"
...
# Ya recopilados: 'Seguridad bogotá','Homicidio bogotá',
"""
...
for pal in palabras:
    ...
    for year in range(inicio, fin+1):
        ...
        try:
            ...
            results = []
            get_results(a_buscar, my_cse_id, results, keys, count_keys)
            ...
            a_buscar2 = 'site:publimetro.co/co ' + a_buscar
        ...
        test_df=pd.DataFrame({'Titulo':titles_tot,
                      'Fecha':dates_tot,
...
test_df.to_excel("Publimetro_articulos_total_3.xlsx")
errores.to_excel("Publimetro_errores_total_3.xlsx")
vacios.to_excel("Publimetro_vacios_total_3.xlsx")
